...
//             child: Align(
//               alignment: layoutPortrait ? Alignment.center : Alignment.center,
//               widthFactor: 1,
//               heightFactor: 1,
//               child: Semantics(
//                 selected: amSelected,
...
//     switch (orientation) {
//       case Orientation.portrait:
//         return headerTextTheme.display3.copyWith(fontSize: 40.0);
//       case Orientation.landscape:
//         return headerTextTheme.display2.copyWith(fontSize: 32.0);
//     }
//     return null;
//   }
...
//         break;
//       case Brightness.dark:
//         //todo here we change the color of the header texts
//         activeColor = Colors.black87;
//         inactiveColor = Colors.black54;
...
//     final TextTheme headerTextTheme = themeData.accentTextTheme;
...
//     media = MediaQuery.of(context).copyWith(alwaysUse24HourFormat: false);
//   }
...
//   final GlobalKey<TimePickerDialogState> controlKey;

//   @override
//   TimePickerDialogState createState() => TimePickerDialogState(controlKey);
// }

// class TimePickerDialogState extends State<TimePickerDialog> {
//   TimePickerDialogState(this.controlKey);
...
//   void clearTime(TimeOfDay time) {
//     print("This method is now called finally");
// //    this.setState(() {
// //      _selectedTime = TimeOfDay.fromDateTime(DateTime.now());
// //      _mode = _TimePickerMode.hour;
// //      _lastModeAnnounced = _TimePickerMode.hour;
// //    });
...
//   void handleTimeChanged(TimeOfDay value) {
//     print("The new value of time is now $value");
//     _vibrate();
//     setState(() {
//       _selectedTime = value;
//     });
