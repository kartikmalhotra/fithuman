...
import 'package:brainfit/screens/event_schedular/screens/event_discription_screen.dart';
...
class _EventLocationScreenState extends State<EventLocationScreen> {
  ...
  void initState() {
    ...
    if (createData["location"] != null) {
      _importantTextController.text = Utils.utf8convert(createData["location"]);
    }
    super.initState();
  }
      ...
      children: <Widget>[
        ...
        Card(
          ...
          child: Padding(
            ...
            child: Text('Where is this commitment ?',
            ...
            Expanded(
              child: Container(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    if (_importantTextController.text.isNotEmpty) {
                      createData["location"] = _importantTextController.text;
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          settings: RouteSettings(name: "EB"),
                          builder: (context) => EventDiscriptionScreen(
                      ...
                      Utils.showFailureToast("Please enter a location");
                    }
                  },
                  child: Text(
                    'Next',
